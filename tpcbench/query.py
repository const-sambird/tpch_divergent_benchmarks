...
from tpcbench import postgresqldb as pgdb, result as r, load, prepare as prep
...
def main(phase: str, replicas: list[Replica], routes: list[int], index_config,
    ...
    dbgen_dir = os.path.join('.', 'tpch-dbgen')
